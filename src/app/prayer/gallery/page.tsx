...
export default function PrayerGalleryPage() {
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Photos from our prayer meetings and events."
        breadcrumbs={[
          { label: "Prayer", href: "/prayer" },
          { label: "Gallery", href: "/prayer/gallery" },
        ]}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          <div className="reveal-on-scroll mb-12 text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 text-lg">
              Moments from our prayer gatherings and intercession meetings.
            </p>
          </div>
