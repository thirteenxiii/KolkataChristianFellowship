...
const images = Array.from({ length: 24 }, (_, i) => ({
  src: `https://placehold.co/600x600/e8f0fe/1a3a6b?text=Impact+${i + 1}`,
  alt: `Impact ${i + 1}`,
  description:
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Photos from our outreach and community impact."
        breadcrumbs={[
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          <div className="reveal-on-scroll mb-12 text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 text-lg">
              Images from Sonarpur, Madhyamgram, Sulkuni, Nirmaan, School of Excellence, and more.
            </p>
          </div>
