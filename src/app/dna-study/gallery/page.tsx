...
const images = Array.from({ length: 24 }, (_, i) => ({
  src: `https://placehold.co/600x600/e8f0fe/1a3a6b?text=DNA+${i + 1}`,
  alt: `DNA Study ${i + 1}`,
  description:
...
export default function DnaStudyGalleryPage() {
  ...
  return (
    <div>
      <PageHeader
        title="DNA Study Gallery"
        subtitle="Photos from our DNA Study series."
        breadcrumbs={[
          { label: "DNA Study", href: "/dna-study" },
          { label: "Gallery", href: "/dna-study/gallery" },
        ]}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          <div className="reveal-on-scroll mb-12 text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 text-lg">
              Visual highlights from our DNA Study series exploring the early church.
            </p>
          </div>
