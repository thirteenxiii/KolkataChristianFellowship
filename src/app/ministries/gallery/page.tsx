...
const images = Array.from({ length: 24 }, (_, i) => ({
  src: `https://placehold.co/600x600/e8f0fe/1a3a6b?text=Ministries+${i + 1}`,
  alt: `Ministries ${i + 1}`,
  description:
...
export default function MinistriesGalleryPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Ministries Gallery"
        subtitle="Photos from our various ministries."
        breadcrumbs={[
          { label: "Ministries", href: "/ministries" },
          { label: "Gallery", href: "/ministries/gallery" },
        ]}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          <div className="reveal-on-scroll mb-12 text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 text-lg">
              Moments captured from Kids Church, Teens on Track, Freedom Church, and more.
            </p>
          </div>
